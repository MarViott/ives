...
function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Shipping Star Solutions | Get a Free Quote</title>
        <meta
          name="description"
          content="Get in touch with Shipping Star Solutions for logistics and transportation services. Schedule a meeting, request a quote, or chat with our team. 24/7 emergency line available."
        />
        <meta
          name="keywords"
          content="contact shipping star, logistics quote, transportation services contact, schedule meeting, freight quote, logistics consultation"
        />
        <meta property="og:title" content="Contact Shipping Star Solutions" />
        <meta
          property="og:description"
          content="Ready to optimize your logistics? Let's discuss how we can help your business grow"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://shippingstarsolutions.com/contact"
        />
        <link
          rel="canonical"
          href="https://shippingstarsolutions.com/contact"
        />
      </Helmet>
      ...
      <div className="contact-page">
        ...
        <section className="contact-hero">
          <div className="hero-content">
            <h1>Get in Touch</h1>
            <p>
              Ready to optimize your logistics? Let's discuss how we can help
              your business grow.
            </p>
