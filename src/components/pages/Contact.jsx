...
function Contact() {
  ...
  const openWhatsApp = () => {
    const phoneNumber = "1234567890"; // Reemplaza con tu número de teléfono (código de país + número)
    const message = "Hola! Me interesa conocer más sobre sus servicios de logística y transporte.";
    ...
    <div className="contact-container subtitle">
      ...
      <div className="social-section">        
        <div className="social-links">
          ...
          <a href="https://www.instagram.com/ivesviotti/" target="_blank" rel="noopener noreferrer" title="Instagram">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.linkedin.com/in/ivesviotti/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="whatsapp-float" onClick={openWhatsApp} title="Contactar por WhatsApp">
        <svg 
          width="30" 
          height="30" 
          viewBox="0 0 24 24" 
